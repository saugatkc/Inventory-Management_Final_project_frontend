...
public class productsOutgoingActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPage.setText("Product Outgoing");
...
//                    Intent add = new Intent(productsOutgoingActivity.this, AddProductOutgoing.class);
//                    startActivity(add);
//                }
//            });
        loadProductOutgoing();
    ...
    private void loadProductOutgoing() {

        UsersAPI usersAPI = url.getInstance().create(UsersAPI.class);
        Call<List<ProductsOutgoing>> productsOutgoingCALL = usersAPI.getProductsOutgoing();

        productsOutgoingCALL.enqueue(new Callback<List<ProductsOutgoing>>() {
            @Override
            public void onResponse(Call<List<ProductsOutgoing>> call, Response<List<ProductsOutgoing>> response) {
                if(!response.isSuccessful()){
                    Toast.makeText(getApplicationContext(), "Errror", Toast.LENGTH_SHORT).show();
                    return;
                }

                List<ProductsOutgoing> productsOutgoingList = response.body();
                for (ProductsOutgoing productsOutgoing : productsOutgoingList){
                    ProductOutgoingAdapter ha = new ProductOutgoingAdapter(getApplicationContext(), productsOutgoingList);
            ...
            @Override
            public void onFailure(Call<List<ProductsOutgoing>> call, Throwable t) {
    ...
    private void navigationDrawer() {
        ...
        navigationView.setNavigationItemSelectedListener(this);
           navigationView.setCheckedItem(R.id.productOutgoing);
...
// Translate the View, accounting for the scaled width
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                AlertDialog.Builder builder = new AlertDialog.Builder(productsOutgoingActivity.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        SharedPreferences sharedPreferences = productsOutgoingActivity.this.getSharedPreferences("IMS", MODE_PRIVATE);
                        ...
                        url.token = "Bearer ";
                        url.status = "Status";
                        Intent i = new Intent(productsOutgoingActivity.this, LoginActivity.class);
