...
public class productsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPage.setText("Products");
        add = findViewById(R.id.imgAdd);
        add.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                Intent add = new Intent(productsActivity.this, AddProduct.class);
                startActivity(add);
            }
        });
        loadproducts();
    ...
    private void loadproducts() {
        ...
        Call<List<Products>> productCall = usersAPI.getProducts();
        ...
        productCall.enqueue(new Callback<List<Products>>() {
            ...
            public void onResponse(Call<List<Products>> call, Response<List<Products>> response) {
                ...
                for (Products products : productsList){
                    ProductAdapter  ha = new ProductAdapter(getApplicationContext(), productsList);
    ...
    private void navigationDrawer() {
        ...
        navigationView.setNavigationItemSelectedListener(this);
           navigationView.setCheckedItem(R.id.product);
            ...
            case R.id.logout:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        SharedPreferences sharedPreferences = productsActivity.this.getSharedPreferences("IMS", MODE_PRIVATE);
