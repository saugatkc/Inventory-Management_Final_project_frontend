...
public class materialsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPage.setText("Materials");
            add = findViewById(R.id.imgAdd);
            add.setOnClickListener(new View.OnClickListener() {

                @Override
                public void onClick(View v) {
                    Intent add = new Intent(materialsActivity.this, AddMaterial.class);
                    startActivity(add);
                }
            });
        laodMaterials();
    ...
    private void laodMaterials() {

        UsersAPI usersAPI = url.getInstance().create(UsersAPI.class);
        Call<List<Materials>> materialsCALL = usersAPI.getMaterials();

        materialsCALL.enqueue(new Callback<List<Materials>>() {
            @Override
            public void onResponse(Call<List<Materials>> call, Response<List<Materials>> response) {
                ...
                List<Materials> materialsList = response.body();
                for (Materials material : materialsList){
                    MaterialAdapter ha = new MaterialAdapter(getApplicationContext(),materialsList);
            ...
            case R.id.logout:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        SharedPreferences sharedPreferences = materialsActivity.this.getSharedPreferences("IMS", MODE_PRIVATE);
                        ...
                        url.token = "Bearer ";
                        url.status = "Status";
                        Intent i = new Intent(materialsActivity.this, LoginActivity.class);
