...
import com.example.inventorymanagement.adapter.DailyProductAdapter;
...
public class dailyProductsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPage.setText("Daily Products");
//        add = findViewById(R.id.imgAdd);
//        add.setOnClickListener(new View.OnClickListener() {
//
//            @Override
//            public void onClick(View v) {
//                Intent add = new Intent(dailyProductsActivity.this, AddDailyProduct.class);
//                startActivity(add);
//            }
//        });
    ...
    private void loadDailyProducts() {

        UsersAPI usersAPI = url.getInstance().create(UsersAPI.class);
        Call<List<DailyProducts>> dailyProductCall = usersAPI.getDailyProducts();

        dailyProductCall.enqueue(new Callback<List<DailyProducts>>() {
            @Override
            public void onResponse(Call<List<DailyProducts>> call, Response<List<DailyProducts>> response) {
                if(!response.isSuccessful()){
                    Toast.makeText(getApplicationContext(), "Errror", Toast.LENGTH_SHORT).show();
                    return;
                }

                List<DailyProducts> dailyProductsList = response.body();
                for (DailyProducts dailyProduct : dailyProductsList){
                    DailyProductAdapter ha = new DailyProductAdapter(getApplicationContext(), dailyProductsList);
            ...
            @Override
            public void onFailure(Call<List<DailyProducts>> call, Throwable t) {
    ...
    private void navigationDrawer() {
        ...
        navigationView.setNavigationItemSelectedListener(this);
           navigationView.setCheckedItem(R.id.dailyProduct);
...
// Translate the View, accounting for the scaled width
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                AlertDialog.Builder builder = new AlertDialog.Builder(dailyProductsActivity.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        SharedPreferences sharedPreferences = dailyProductsActivity.this.getSharedPreferences("IMS", MODE_PRIVATE);
                        ...
                        url.token = "Bearer ";
                        url.status = "Status";
                        Intent i = new Intent(dailyProductsActivity.this, LoginActivity.class);
